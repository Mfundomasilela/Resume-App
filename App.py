...
def run():
    ...
    st.sidebar.markdown("# Select one of the following!")
    activities = ["User", "Admin"]
    choice = st.sidebar.selectbox("Select the most suitable options:", activities)
    ...
    if choice == 'User':
        st.markdown('''<h5 style='text-align: left; color: #021659;'> Upload your resume, and discover new opportunities!</h5>''',
